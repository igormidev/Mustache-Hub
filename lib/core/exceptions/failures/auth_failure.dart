...
@immutable
abstract class CredentialAuthException extends CustomException {
...
@immutable
abstract class GoogleAuthException extends CustomException {
...
class NoInternetDetected extends CredentialAuthException {
  NoInternetDetected(FirebaseAuthException error)
      : super(
          code: error.code,
          message: 'No connection with internet',
          description:
